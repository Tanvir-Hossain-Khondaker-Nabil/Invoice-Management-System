                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-0">{{ App\Models\User::get()->count() }}</h4>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-0">{{ App\Models\Customer::get()->count() }}</h4>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-0">{{ App\Models\Product::get()->count() }}</h4>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-0">{{ App\Models\Invoice::select('invoice_number')->groupBy('invoice_number')->get()->count() }}</h4>
                                    </div>
